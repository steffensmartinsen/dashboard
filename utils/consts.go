...
const DEFAULT_PATH = "/dashboards/" + VERSION + ROOT
...
const PATH_REGISTRATIONS = DEFAULT_PATH + ENDPOINT_REGISTRATIONS + ROOT
...
const PATH_AUTHENTICATION = DEFAULT_PATH + ENDPOINT_AUTHENTICATION + ROOT
...
const PATH_DASHBOARD = DEFAULT_PATH + ENDPOINT_DASHBOARD + ROOT
...
const PATH_SET_COOKIE = DEFAULT_PATH + ENDPOINT_SET_COOKIE + ROOT
...
const PATH_GET_COOKIE = DEFAULT_PATH + ENDPOINT_GET_COOKIE + ROOT
